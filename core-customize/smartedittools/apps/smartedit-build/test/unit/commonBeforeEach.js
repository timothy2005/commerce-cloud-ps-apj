...
beforeEach(
    angular.mock.module('legacySmarteditServicesModule', function($provide, $injector) {
        if (!$injector.has('experienceService')) {
            var experienceService = jasmine.createSpyObj('experienceService', [
        ...
        if (!$injector.has('catalogService')) {
            var catalogService = jasmine.createSpyObj('catalogService', [
        ...
        if (!$injector.has('pageInfoService')) {
            var pageInfoService = jasmine.createSpyObj('pageInfoService', [
                'getPageUID',
                'getPageUUID',
