...
describe('Tree - ', () => {
    describe('Legacy -', () => {
        ...
        describe('1st level - ', () => {
            ...
            it('nodes have correct title attributes', async () => {
                await TreePageObject.Assertions.nodeHasTitle('node1', 'node1_en');
                await TreePageObject.Assertions.nodeHasTitle('node2', 'node2_en');
            });
