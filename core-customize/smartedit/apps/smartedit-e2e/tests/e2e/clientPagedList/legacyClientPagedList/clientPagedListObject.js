...
var PageList = function (PERSPECTIVE_SERVICE_RESULT) {
    ...
    this.pageURI =
        '/apps/smartedit-e2e/generated/e2e/clientPagedList/legacyClientPagedList/index.html?perspectiveServiceResult=' +
...
PageList.prototype = {
    ...
    openMoreMenuFirstElement: function () {
        return element.all(by.css('.se-dropdown-more-menu')).first().click();
    },
