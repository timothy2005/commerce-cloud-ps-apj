...
describe('CmsItemDropdown -', function () {
    ...
    describe('Single Select - ', function () {
        ...
        it(
            'GIVEN an item is selected and opened in a nested editor WHEN the user saves it THEN the editor must close saving' +
                ' any changes',
            async function () {
                ...
                // GIVEN
                page.actions.openGenericEditor();
                cmsItemDropdown.actions.selectItemInDropdown(
                    BANNER_FIELD_ID,
                    SINGLE_SELECT,
                    BANNER_1
                );
