    ...
    it(
        ...
        function () {
            selectFileToUpload('invalid.doc').then(function () {
                ...
                browser.waitForPresence(element(by.css(getCssForEnglish(mediaErrorsSelector))));
                expect(element(by.css(getCssForEnglish(mediaErrorsSelector))).getText()).toContain(
    ...
    it(
        ...
        function () {
            selectFileToUpload('more_bckg.png').then(function () {
                browser.waitUntil(
                    EC.presenceOf(
                        element(by.css(getCssForEnglish('.se-media-upload-form__file-name')))
                    ),
                    'Timed out waiting for presence of file name element'
                );
                expect(
                    element(by.css(getCssForEnglish('.se-media-upload-form__file-name'))).getText()
                ).toBe('more_bckg.png');
                browser.waitUntil(
        ...
        function () {
            selectFileToUpload('more_bckg.png')
                ...
                .then(function () {
                    ...
                    browser.waitForAbsence(element(by.css(getCssForEnglish(mediaErrorsSelector))));
