    ...
    .constant('navigationNodeNodes', [
        {
            ...
            children: [
                {
                    uid: 'CMSNavigationNode-1',
                    name: 'CMSNavigationNode-1',
                    uuid: 'CMSNavigationNode-1',
                    itemtype: 'CMSNavigationNode'
                },
                {
                    uid: 'CMSNavigationNode-2',
                    name: 'CMSNavigationNode-2',
        ...
        },
        {
            ...
            children: [
                {
                    uid: 'CMSNavigationNode-4',
                    name: 'CMSNavigationNode-4',
                    uuid: 'CMSNavigationNode-4',
                    itemtype: 'CMSNavigationNode'
                },
                {
                    uid: 'CMSNavigationNode-5',
                    name: 'CMSNavigationNode-5',
                    uuid: 'CMSNavigationNode-5',
                    itemtype: 'CMSNavigationNode'
                },
                {
                    uid: 'CMSNavigationNode-7',
                    name: 'CMSNavigationNode-7',
        ...
        },
        {
            ...
            children: [
                {
                    uid: 'CMSNavigationNode-6',
                    name: 'CMSNavigationNode-6',
        ...
        },
        {
            ...
            children: [
                {
                    uid: 'CMSNavigationNode-8',
                    name: 'CMSNavigationNode-8',
        ...
        },
        {
            ...
            children: [
                {
                    uid: 'CMSNavigationNode-9',
                    name: 'CMSNavigationNode-9',
    ...
    .factory('navigationNodePOST', function (navigationNodeNodes) {
        return function (data) {
            ...
            if (parent) {
                ...
                parent.children.push({ uid: payload.uid, name: payload.name, uuid: payload.uuid });
            }
