...
module.exports = {
    ...
    _getNodeTitle: function (nodeLabel) {
        ...
        var selector =
            "//div[contains(@class, 'se-tree-node__name')]/span[contains(., '" +
            nodeLabel +
            "')]/ancestor::div[contains(@class, 'se-tree-node')]//div[contains(@class, 'se-tree-node__title')]/span";
    ...
    clickOnLinkHavingClassInRenderer: function (nodeLabel, cssClass) {
        return browser.click(
            by.xpath(
                "//div[contains(@class, 'se-tree-node__name')]/span[contains(., '" +
                    nodeLabel +
                    "')]/ancestor::div[contains(@class, 'se-tree-node')]//se-dropdown-menu//div[contains(@class, '" +
                    cssClass +
                    "')]"
            )
        );
    ...
    getChildrenNames: function (nodeLabel) {
        ...
        if (nodeLabel) {
            selector = by.xpath(
                "//div[contains(@class, 'se-tree-node__name')]/span[contains(., '" +
                    nodeLabel +
                    "')]/ancestor::se-tree-node-renderer/se-tree-node//div[contains(@class, 'se-tree-node__name')]"
            );
        } else {
    ...
    getMoreMenuOptions: function (nodeLabel) {
        ...
        if (nodeLabel) {
            selector = by.xpath(
                "//div[contains(@class, 'se-tree-node__name')]/span[contains(., '" +
                    nodeLabel +
                    "')]/ancestor::div[contains(@class, 'se-tree-node')]//se-dropdown-menu//ul/se-dropdown-menu-item/li"
            );
        } else {
    ...
    getMoreMenuItem: function (nodeLabel, option) {
        return by.xpath(
            "//div[contains(@class, 'se-tree-node__name')]/span[contains(., '" +
                nodeLabel +
                "')]/ancestor::div[contains(@class, 'se-tree-node')]//se-dropdown-menu//a[contains(., '" +
                option +
                "')]"
        );
    },
