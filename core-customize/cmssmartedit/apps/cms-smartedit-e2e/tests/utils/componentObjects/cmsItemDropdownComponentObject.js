    ...
    componentObject.elements = {
        ...
        getDropdownOptionById: function (fieldQualifier, itemId) {
            return this.getDropdownByQualifier(fieldQualifier).element(
                by.css(
                    '.ui-select-choices-group se-cms-dropdown-item [data-component-id="' +
                        itemId +
                        '"]'
                )
            );
        ...
        getSingleSelectSelectedItemById: function (fieldQualifier, itemId) {
            return this.getDropdownByQualifier(fieldQualifier).element(
                by.css(
                    '.ui-select-match .y-select-item-printer se-cms-dropdown-item [data-component-id="' +
                        itemId +
                        '"]'
                )
            );
        ...
        getSelectedItemRemoveButton: function (fieldQualifier, componentId) {
            ...
            var xPathExpression =
                '//li[contains(@class, "ui-select-match-item")][//se-cms-dropdown-item/*[@data-component-id="' +
                componentId +
                '"]]/a';
